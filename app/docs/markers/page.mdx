...
- **Icon** — when `icon` is set. A colored circle with a white icon inside.
...
| Icon | Name | Good for |
|---|---|---|
| 📍 | `map-pin` | Generic location |
| ⭐ | `star` | Highlights, favorites |
| ❤️ | `heart` | Liked places |
| 🚩 | `flag` | Start/end points |
| ☕ | `coffee` | Cafes |
| 🍴 | `utensils` | Restaurants |
| 🏨 | `hotel` | Hotels, lodging |
| 🏢 | `building-2` | Offices, buildings |
| 🌲 | `tree-pine` | Parks, nature |
| ⛰️ | `mountain` | Mountains, hiking |
| ✈️ | `plane` | Airports |
...
| 📷 | `camera` | Photo spots, landmarks |
| 🏛️ | `landmark` | Monuments, government |
| ⛺ | `tent` | Camping |
