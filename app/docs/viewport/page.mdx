...
|----------|------|---------|-------------|
| `center` | `[lng, lat]` | `[0, 20]` | Map center as longitude, latitude |
| `zoom` | `number` | `1.5` | Zoom level (0–24) |
| `pitch` | `number` | `0` | Camera tilt in degrees (0–85) |
| `bearing` | `number` | `0` | Camera rotation in degrees (-180–180, 0 = north) |
| `bounds` | `[w, s, e, n]` | — | Fit map to bounding box (overrides center/zoom) |
